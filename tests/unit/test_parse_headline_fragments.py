...
class TestParseHeadlineFragments:
    ...
    def test_single_highlight(self, repository):
        ...
        fragments = repository._parse_ts_headline_fragments(
            html, context_size_before, context_size_after
        )
        print(fragments)
    ...
    def test_highlight_positions(self, repository):
        ...
        highlighted_part = context.text[
            context.highlight_start : context.highlight_start + context.highlight_length
        ]
    ...
    def test_various_context_sizes(
        self, repository, context_size_before, context_size_after
    ):
    ...
    def test_new_line_in_context(self, repository):
        ...
        fragments = repository._parse_ts_headline_fragments(html, 100, 100)
        assert (
            fragments[0].context.text
            == "контекст с новой строкой d      выделение с новой строкой e"
        )
